    ...
    ItemObject.prototype = {
        createDom: function () {
            ...
            .append($("<div></div>").addClass("block-b")
                .append($("<div></div>").addClass("block-b-1 textdata small").append(item.id || "&nbsp;"))
                .append($("<div></div>").addClass("block-b-2 textdata large").append(item.name || "&nbsp;"))
                .append($("<div></div>").addClass("block-b-3 textdata small").append(item.kana || "&nbsp;"))
            )
            .append($("<div></div>").addClass("block-d")
                .append($("<div></div>").addClass("block-d-1 textdata").append(item.section || "&nbsp;"))
                .append($("<div></div>").addClass("block-d-2 textdata").append(item.rank || "&nbsp;"))
                //.append($("<div></div>").addClass("block-d-3 textdata").append("<div class='small'>(内線)</div>").append("&nbsp;" + item.phone))
            ...
            .append($("<div></div>").addClass("block-p")
                .append($("<div></div>").addClass("block-p-1 textdata").append(item.jotai || "&nbsp;"))
                .append(Manager.UpdateBackup[item.id] ? $("<div></div>").addClass("block-p-z")
                    .append(common.createButton("", "undo mini", "ui-icon-back"))
                : "")
                .append($("<div></div>").addClass("block-p-2 textdata").append(item.yukisaki || "&nbsp;"))
                .append($("<div></div>").addClass("block-p-3 textdata").append(item.nichiji || "&nbsp;"))
